    ...
    border-color: green;
       ...
       <script>
        function addToWishlist(bookId) {
            ...
            form.method = 'post';
            form.action = 'fiction_new.php'; // Assuming the same file name
        ...
        <div class="col-md-12 card-container">
            ...
            <div class="row">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    $sql = "SELECT * FROM add_books WHERE category = 'fiction' AND email != '$loggedInUserEmail'";
                } else {
                    // If the user is not logged in, retrieve all non-fiction books
                    $sql = "SELECT * FROM add_books WHERE category = 'fiction'";
                }
