...
<?php include 'user_header.php'; ?>
    ...
    <div class="card-container">
        <div class="card" onclick="window.location.href='fiction_new.php';">
        ...
        <div class="card" onclick="window.location.href='non_fiction.php';">
       ...
       <div class="card" onclick="window.location.href='reference.php';">
        ...
        <div class="card" onclick="window.location.href='poetry.php';">
        ...
        </div><div class="card" onclick="window.location.href='drama.php';">
        ...
        <div class="card" onclick="window.location.href='childrens-literature.php';">
		...
		<div class="card" onclick="window.location.href='religious-spiritual.php';">
        ...
        <div class="card" onclick="window.location.href='academic-textbook.php';">
		...
		<div class="card" onclick="window.location.href='graphic-novels-comic.php';">
        ...
        <div class="card" onclick="window.location.href='diy-and-hobby.php';">
